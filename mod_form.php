...
class mod_pluginpatroller_mod_form extends moodleform_mod
{
    ...
    function definition()
    {
        ...
        $mform->addElement('text', 'max_users_per_group', get_string('max_users_per_group', 'pluginpatroller'));
        $mform->setType('max_users_per_group', PARAM_INT);
        $mform->setDefault('max_users_per_group', 4); // Valor por defecto de 4 alumnos
        $mform->addRule('max_users_per_group', null, 'required', null, 'client');
